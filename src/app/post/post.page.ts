...
export class PostPage implements OnInit {
  ...
  newComment: string = '';
  comments: Comment[] = [
    { id: 1, username: 'user1', content: 'Great post!', date: new Date().toLocaleDateString() },
    { id: 2, username: 'user2', content: 'Thanks for sharing!', date: new Date().toLocaleDateString() },
  ];
